...
TEST_CASE("Value JSON serialization", "[value][json]")
{
    SECTION("Null value")
    {
        Value v;
...
TEST_CASE("Value JSON nested structures", "[value][json]")
{
    SECTION("Nested objects")
    {
        Value v;
...
TEST_CASE("Value JSON pretty printing", "[value][json]")
{
...
TEST_CASE("Value JSON error handling", "[value][json]")
{
...
TEST_CASE("Value JSON roundtrip with structs", "[value][json]")
{
    SECTION("Simple struct")
    {
        Simple original{42, 3.14f, 2.71};
...
TEST_CASE("Value JSON special cases", "[value][json]")
{
    SECTION("Empty array")
    {
        Value v(Array{});
    ...
    {
        Value v(9223372036854775807LL); // max int64_t
        std::string json = value_to_json(v, false);
...
TEST_CASE("Value JSON configuration example", "[value][json]")
{
